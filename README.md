...
- ~`74 µs` per inference in simulation

Approximate throughput:

```math
\frac{1}{74 \times 10^{-6}} \approx 13,500 \text{ inferences/sec}
```
...
>
> Since the architecture is sequential MAC-based, the accelerator can be significantly sped up by:
>
> - Increasing clock frequency
> - Introducing parallel MAC units
> - Deep pipelining
> - BRAM optimization
...
![Waveform](./Waveforms/waveform_0.png)
